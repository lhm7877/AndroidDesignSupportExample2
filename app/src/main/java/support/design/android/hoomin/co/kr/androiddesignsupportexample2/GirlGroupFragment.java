...
public class GirlGroupFragment extends Fragment{
    ...
    public static class GirlsGroupRecyclerViewAdapter extends RecyclerView.Adapter<GirlsGroupRecyclerViewAdapter.ViewHolder>{
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            holder.memberName.setText(RandomArrayList.getGirlGroupName(
                    girlsImages.get(position)));
            ...
            public void onClick(View v){
                    ...
                    Intent intent = new Intent(
                            GirlsApplication.getGirlsContext(),
                            GirlsMemberDetailActivity.class);
                    ...
                    ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(
                            owner,
                            holder.girlsImage, ViewCompat.getTransitionName(holder.girlsImage));
